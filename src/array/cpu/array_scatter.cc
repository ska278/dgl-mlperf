...
template NDArray Scatter<kDGLCPU, bfloat8, int32_t>(NDArray, IdArray);
...
template NDArray Scatter<kDGLCPU, bfloat8, int64_t>(NDArray, IdArray);
...
template void Scatter_<kDGLCPU, bfloat8, int32_t>(IdArray, NDArray, NDArray);
...
template void Scatter_<kDGLCPU, bfloat8, int64_t>(IdArray, NDArray, NDArray);
